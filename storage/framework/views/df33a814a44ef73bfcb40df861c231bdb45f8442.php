        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(URL::route('post-edit')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" value="<?php echo e($patientID->name); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('dob') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control" name="dob" value="<?php echo e($patientID->dob); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('gender') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="gender" value="<?php echo e($patientID->gender); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('marital') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="marital" value="<?php echo e($patientID->marital); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('national') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="national" value="<?php echo e($patientID->national); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('nhif') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="nhif" value="<?php echo e($patientID->nhif); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="email" class="form-control" name="email" value="<?php echo e($patientID->email); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="phone" value="<?php echo e($patientID->phone); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('home') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="home" value="<?php echo e($patientID->home); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('location') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="location" value="<?php echo e($patientID->location); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('education') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="education" value="<?php echo e($patientID->education); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('occupation') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="occupation" value="<?php echo e($patientID->occupation); ?>">
                        ...
                        <input type="hidden" name="id" value="<?php echo e($patientID->id); ?>">
                    </form>
                </div>
            </div>
        </div>
